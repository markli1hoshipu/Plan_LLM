"""
Train Qwen3-4B with DPO using its own generated samples.
...
class DataArguments:
    train_file: str = field(
        default="/work/markhsp/hsp_pddl/data/processed/dpo_data/qwen3_4b/train_dpo.jsonl",
        metadata={"help": "Path to training data"}
    )
    eval_file: str = field(
        default="/work/markhsp/hsp_pddl/data/processed/dpo_data/qwen3_4b/eval_dpo.jsonl",
